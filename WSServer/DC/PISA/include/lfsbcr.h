/******************************************************************************
*                                                                             *
* LFSbcr.h  - Barcode Reader (BCR) definitions                                *
*                                                                             *
* Version 1.00                                                                *
*                                                                             *
******************************************************************************/
...
#define LFS_SERVICE_CLASS_VERSION_BCR				(0x0001) /* Version 1.0 */
...
typedef struct _LFS_BCR_status
{
	WORD wDevice;
	WORD wBcr_Scanner;
	DWORD dwGuid_Lights[LFS_BCR_GUIDLIGHTS_SIZE];
	LPSTR lpstrExtra;
...
{
	WORD wSymbology;
	LPLFSBCRXDATA lpBarcode_Data;
	LPSTR lpstr_Symbology_Name;
} LFSBCRREADOUTPUT, *LPLFSBCRREADOUTPUT;

typedef struct _LFS_BCR_set_guid_light
{
	WORD wGuid_Light;
	DWORD dwCommand;
