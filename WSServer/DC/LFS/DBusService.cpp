...
// ������� undefined reference to symbol 'g_main_context_push_thread_default' �������
...
DBusHandlerResult server_message_handler(DBusConnection *conn, DBusMessage *message, void *data)
{
	...
	if (dbus_message_is_method_call(message, DBUS_INTERFACE_INTROSPECTABLE, "Introspect")) {
		...
		// ��path������ /lfs/dcidcardreader/listener���нس�DCName
...
DBusConnection * StartupDBus(char * szPathName)
{
	...
	char szarrPath[][64] =
	{
		"/lfs/DCCardReader/listener",  // �Ӵ�������
		"/lfs/DCChipCardReader/listener",  // IC������
		"/lfs/DCRFChipCardReader/listener",  // �ǽ�IC������
		"/lfs/DCIDCardReader/listener",  // ����֤
		"/lfs/DCUKeyReader/listener",  // UKey�����Ķ���
		"/lfs/DCPinPad/listener",  // �������
		"/lfs/DCJournalPrinter/listener",  // ��ˮ��ӡ��
		"/lfs/DCReceiptPrinter/listener",  // ƾ����ӡ��
		"/lfs/DCPassBookPrinter/listener",  // ���۴�ӡ��
		"/lfs/DCStatementPrinter/listener",  // ���˵���ӡ��
		"/lfs/DCInvoicePrinter/listener",  // ��Ʊ��ӡ��
		"/lfs/DCDocumentPrinter/listener",  // �ĵ���ӡ��
		"/lfs/DCDocumentRetractPrinter/listener",  // �ĵ�����
		"/lfs/DCFingerPrinter/listener",  // ָ���ǣ����ڴ�ӡ����ָ����
		"/lfs/DCCashAcceptor/listener",  // ���ģ��
		"/lfs/DCCashDispenser/listener",  // ȡ��ģ��
		"/lfs/DCOperatorPanel/listener",  // ����Ա���
		"/lfs/DCSensorsAndIndicators/listener",  // ������/ָʾ��
		"/lfs/DCVendorMode/listener",  // ����ģʽ
		"/lfs/DCScanner/listener",  // ɨ����
		"/lfs/DCBarcode/listener",  // ��ά��
		"/lfs/DCCardDispenser/listener",  // ����
		"/lfs/DCCamera/listener"   // ����ͷ
	};
