/*******************************************************************************
 *                                                                             *
 * lfsttu.h      LFS- Text Terminal Unit (TTU) definitions                     *
 *                                                                             *
...
/* values of LFSTTUCAPS.wClass */

#define LFS_SERVICE_CLASS_TTU         (6)
#define LFS_SERVICE_CLASS_VERSION_TTU (0x0001)  // Version 1.00
...
#define LFS_CMD_TTU_SET_LED_EX          (TTU_SERVICE_OFFSET + 13)
#define LFS_CMD_TTU_SYNCHRONIZE_COMMAND (TTU_SERVICE_OFFSET + 14)
...
/* Values of LFSTTUSTATUS.fwDevice */
...
#define LFS_TTU_DEVFRAUDATTEMPT   LFS_STAT_DEVFRAUDATTEMPT
#define LFS_TTU_DEVPOTENTIALFRAUD LFS_STAT_DEVPOTENTIALFRAUD

/* Values of LFSTTUSTATUS.wKeyboard */

#define LFS_TTU_KBDNA  (0)
#define LFS_TTU_KBDON  (1)
#define LFS_TTU_KBDOFF (2)

/* Values of LFSTTUSTATUS.wKeyLock */
...
/* Values of LFSTTUSTATUS.fwLEDs
             LFSTTUSTATUS.lpLEDEx.lpdwLEDs
             LFSTTUCAPS.lpLEDEx.lpdwLEDs
             LFSTTUSETLEDS.fwCommand */
...
/* Values of LFSTTUSTATUS.lpLEDEx.lpdwLEDs
             LFSTTUCAPS.lpLEDEx.lpdwLEDs
             LFSTTUSETLEDSEX.dwCommand */

#define LFS_TTU_LEDRED     (0x00000100)
#define LFS_TTU_LEDGREEN   (0x00000200)
#define LFS_TTU_LEDYELLOW  (0x00000400)
#define LFS_TTU_LEDBLUE    (0x00000800)
#define LFS_TTU_LEDCYAN    (0x00001000)
#define LFS_TTU_LEDMAGENTA (0x00002000)
#define LFS_TTU_LEDWHITE   (0x00004000)
...
/* values of LFSTTUFIELDFAIL.wFailure */
...
/* values of LFSTTUKEYDETAIL.lpwCommandKeys */
...
#define LFS_ERR_TTU_COMMANDUNSUPP     (-(TTU_SERVICE_OFFSET + 16))
#define LFS_ERR_TTU_SYNCHRONIZEUNSUPP (-(TTU_SERVICE_OFFSET + 17))

/*=================================================================*/
/* TTU Info Command Structures */
/*=================================================================*/

typedef struct _lfs_ttu_led_ex {
  USHORT usNumOfLEDs;
  LPDWORD lpdwLEDs;
} LFSTTULEDEX, *LPLFSTTULEDEX;
...
typedef struct _lfs_ttu_set_leds_ex {
  USHORT usLED;
  DWORD dwCommand;
} LFSTTUSETLEDSEX, *LPLFSTTUSETLEDSEX;

typedef struct _lfs_ttu_synchronize_command {
  DWORD dwCommand;
  LPVOID lpCmdData;
} LFSTTUSYNCHRONIZECOMMAND, *LPLFSTTUSYNCHRONIZECOMMAND;
