/*******************************************************************************
 *                                                                             *
 * lfsapi.h      LFS - API functions, types, and definitions                   *
 *                                                                             *
...
/*
HRESULT extern LFSAPI LFSCancelAsyncRequest(HSERVICE service,
                                            REQUESTID request_id);
...
HRESULT extern LFSAPI LFSAsyncClose(HSERVICE service,
                                    LPSTR object_name,
                                    LPREQUESTID request_id);

HRESULT extern LFSAPI LFSCreateAppHandle(LPHAPP app_handle);

HRESULT extern LFSAPI LFSDeregister(HSERVICE service,
                                    DWORD event_class,
                                    LPSTR object_reg_name);

HRESULT extern LFSAPI LFSAsyncDeregister(HSERVICE service,
                                         DWORD event_class,
                                         LPSTR object_reg_name,
                                         LPSTR object_name,
                                         LPREQUESTID request_id);
...
HRESULT extern LFSAPI LFSExecute(HSERVICE service,
                                 DWORD command,
                                 LPVOID cmd_data,
                                 DWORD timeout,
                                 LPLFSRESULT* result);

HRESULT extern LFSAPI LFSAsyncExecute(HSERVICE service,
                                      DWORD command,
                                      LPVOID cmd_data,
                                      DWORD timeout,
                                      LPSTR object_name,
...
HRESULT extern LFSAPI LFSGetInfo(HSERVICE service,
                                 DWORD category,
                                 LPVOID query_details,
                                 DWORD timeout,
                                 LPLFSRESULT* result);

HRESULT extern LFSAPI LFSAsyncGetInfo(HSERVICE service,
                                      DWORD category,
                                      LPVOID query_details,
                                      DWORD timeout,
                                      LPSTR object_name,
...
HRESULT extern LFSAPI LFSLock(HSERVICE service,
                              DWORD timeout,
                              LPLFSRESULT* result);

HRESULT extern LFSAPI LFSAsyncLock(HSERVICE service,
                                   DWORD timeout,
                                   LPSTR object_name,
                                   LPREQUESTID request_id);

HRESULT extern LFSAPI LFSOpen(LPSTR logical_name,
                              HAPP app_handle,
                              LPSTR app_id,
                              DWORD trace_level,
                              DWORD timeout,
                              DWORD srvc_versions_required,
                              LPLFSVERSION srvc_version,
                              LPLFSVERSION spi_version,
                              LPHSERVICE service);

HRESULT extern LFSAPI LFSAsyncOpen(LPSTR logical_name,
                                   HAPP app_handle,
                                   LPSTR app_id,
                                   DWORD trace_level,
                                   DWORD timeout,
...
HRESULT extern LFSAPI LFSRegister(HSERVICE service,
                                  DWORD event_class,
                                  LPSTR object_reg_name);

HRESULT extern LFSAPI LFSAsyncRegister(HSERVICE service,
                                       DWORD event_class,
                                       LPSTR object_reg_name,
                                       LPSTR object_name,
                                       LPREQUESTID request_id);

HRESULT extern LFSAPI LFSSetBlockingHook(LFSBLOCKINGHOOK block_func,
                                         LPLFSBLOCKINGHOOK prev_func);

HRESULT extern LFSAPI LFSStartUp(DWORD versions_required,
                                 LPLFSVERSION lfs_version);
...
HRESULT extern LFSAPI LFSAsyncUnlock(HSERVICE service,
                                     LPSTR object_name,
                                     LPREQUESTID request_id);
...
typedef HRESULT(*LPLFSCANCELBLOCKINGCALL)(pthread_t thread_id);
