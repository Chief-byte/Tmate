/*******************************************************************************
 *                                                                             *
 * lfsidc.h    LFS - Identification card unit (IDC) definitions                *
 *                                                                             *
...
#define LFS_SERVICE_CLASS_VERSION_IDC (0x0001)  // Version 1.00
...
#define LFS_CMD_IDC_PARK_CARD          (IDC_SERVICE_OFFSET + 15)
...
#define LFS_EXEE_IDC_TRACKDETECTED      (IDC_SERVICE_OFFSET + 15)
...
#define LFS_IDC_DEVPOTENTIALFRAUD LFS_STAT_DEVPOTENTIALFRAUD
...
#define LFS_IDC_TRACK1_JIS1   0x0400
#define LFS_IDC_TRACK3_JIS1   0x0800
/* LFSIDCCARDDATA.data_source 取值 */
...
/* LFSIDCCAPS.write_mode; LFSIDCWRITETRACK.write_method,
 * LFSIDCCARDDATA.write_method 取值 */
...
/* values LFSIDCPARKCARD.wDirection */

#define LFS_IDC_PARK_IN  0x0001
#define LFS_IDC_PARK_OUT 0x0002
...
typedef struct _lfs_idc_park_card {
  WORD direction;
  USHORT parking_station;
} LFSIDCPARKCARD, *LPLFSIDCPARKCARD;
...
typedef struct _lfs_idc_track_detected {
  WORD tracks;
} LFSIDCTRACKDETECTED, *LPLFSIDCTRACKDETECTED;
