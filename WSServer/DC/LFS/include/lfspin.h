/*******************************************************************************
 *                                                                             *
 * lfspin.h    LFS - Personal Identification Number Keypad (PIN) definitions   *
 *                                                                             *
...
#define LFS_SERVICE_CLASS_VERSION_PIN (0x0001)  // Version 1.00
...
#define LFS_INF_PIN_QUERY_PCIPTS_DEVICE_ID   (PIN_SERVICE_OFFSET + 10)
...
#define LFS_CMD_PIN_LOAD_CERTIFICATE_EX                (PIN_SERVICE_OFFSET + 48)
#define LFS_CMD_PIN_IMPORT_RSA_ENCIPHERED_PKCS7_KEY_EX (PIN_SERVICE_OFFSET + 49)
#define LFS_CMD_PIN_DEFINE_LAYOUT                      (PIN_SERVICE_OFFSET + 50)
#define LFS_CMD_PIN_START_AUTHENTICATE                 (PIN_SERVICE_OFFSET + 51)
#define LFS_CMD_PIN_AUTHENTICATE                       (PIN_SERVICE_OFFSET + 52)
#define LFS_CMD_PIN_GET_PINBLOCK_EX                    (PIN_SERVICE_OFFSET + 53)
#define LFS_CMD_PIN_SYNCHRONIZE_COMMAND                (PIN_SERVICE_OFFSET + 54)
...
#define LFS_PIN_DEVPOTENTIALFRAUD LFS_STAT_DEVPOTENTIALFRAUD
...
/* LFSPINCAPS.rsa_authentication_scheme 和 fast-track
 * 能力扩展参数REMOTE_KEY_SCHEME 的取值*/
#define LFS_PIN_RSA_AUTH_2PARTY_SIG  (0x00000001)
#define LFS_PIN_RSA_AUTH_3PARTY_CERT (0x00000002)

/* LFSPINCAPS.signature_scheme 和 fast-track 能力扩展参数 SIGNATURE_CAPABILITIES
 * 的取值*/
...
typedef struct _lfs_pin_export_rsa_issuer_signed_item_output {
  ...
  DWORD rsa_signature_algorithm;
  LPLFSXDATA signature;
} LFSPINEXPORTRSAISSUERSIGNEDITEMOUTPUT,
    *LPLFSPINEXPORTRSAISSUERSIGNEDITEMOUTPUT;
...
typedef struct _lfs_pin_import_rsa_enciphered_pkcs7_key_output {
  WORD key_length;
  LPLFSXDATA rsa_data;
} LFSPINIMPORTRSAENCIPHEREDPKCS7KEYOUTPUT,
    *LPLFSPINIMPORTRSAENCIPHEREDPKCS7KEYOUTPUT;
