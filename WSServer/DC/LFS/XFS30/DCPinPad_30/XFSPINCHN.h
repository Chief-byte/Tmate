...
#define WFS_CMD_WOSA33_ENC_IO_CHN_IMPORT_SM2_SIGNED_SM4_KEY (0x000A)

#define WFS_PIN_KEYDES								(0x0002)
#define WFS_PIN_KEYSM4								(0x0003)
...
/* values of PROTCHNEXPORTSM2EPPSIGNEDITEMIN.wExportItemType */
...
typedef struct _prot_chn_export_sm2_epp_signed_item_out
{
	...
	WORD                   wResult;
	LPLFSXDATA             lpxValue;
	LPLFSXDATA             lpxSelfSignature;
	LPLFSXDATA             lpxSignature;
} PROTCHNEXPORTSM2EPPSIGNEDITEMOUT, *LPPROTCHNEXPORTSM2EPPSIGNEDITEMOUT;

typedef struct _prot_chn_import_sm2_signed_sm4_key_in
{
	WORD                   wCommand;
	LPSTR                  lpsKey;
	LPSTR                  lpsDecryptKey;
	...
	DWORD                  dwSM2SignatureAlgorithm;
	LPLFSXDATA             lpxSignature;
} PROTCHNIMPORTSM2SIGNEDSM4KEYIN, *LPPROTCHNIMPORTSM2SIGNEDSM4KEYIN;
...
typedef struct _prot_chn_import_sm2_signed_sm4_key_wosa33_output
{
	WORD                    wCommand;
	WORD                    wResult;
	WORD                    wKeyCheckMode;
	LPLFSXDATA              lpxKeyCheckValue;
} PROTCHNIMPORTSM2SIGNEDSM4KEYWOSA33OUTPUT, *LPPROTCHNIMPORTSM2SIGNEDSM4KEYWOSA33OUTPUT;
